/*
With this sample, you can obtain and save intensity images, depth maps simultaneously from multiple profilers.
*/
...
class TriggerMultipleProfilersSimultaneously
{
    ...
    static int Main()
    {
        TriggerMultipleProfilersSimultaneouslyImpl();
        Console.WriteLine("Press any key to exit ...");
        Console.ReadKey();
        return 0;
    }

    static async void TriggerMultipleProfilersSimultaneouslyImpl()
    {
        var profilerList = Utils.FindAndConnectMultiProfiler();
    ...
    private static async Task Capture(Profiler profiler)
    {
        ...
        profileBatch.GetIntensityImage().Save("Intensity_" + id + ".png");
    }
}
