/*
With this sample, you can remove the noise in the depth data and obtain the filtered profile data.

NOTE: The noise removal function can only be applied after all profiles have been retrieved.
