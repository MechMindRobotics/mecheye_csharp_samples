...
namespace mmind
{
    namespace apiSharp
    {
        public class MechEyeDevice
        {
            ...
            [DllImport("MechEyeApiWrapper.dll")]
            private static extern void EnumerateMechEyeDeviceList(ref MechEyeDeviceInfo[] list, ref Int32 size);
            ...
            {
                Int32 size = 0;
                List<MechEyeDeviceInfo> list = new List<MechEyeDeviceInfo>();
                MechEyeDeviceInfo[] arr = list.ToArray();
                EnumerateMechEyeDeviceList(ref arr, ref size);
                list = arr.ToList();
                return list;
            }
